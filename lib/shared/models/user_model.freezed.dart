...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, email: $email, firstName: $firstName, lastName: $lastName, createdAt: $createdAt, updatedAt: $updatedAt, phone: $phone, avatar: $avatar, dateOfBirth: $dateOfBirth, gender: $gender, addresses: $addresses)';
  }
...
class _$AddressImpl implements _Address {
  ...
  @override
  String toString() {
    return 'Address(id: $id, label: $label, fullAddress: $fullAddress, city: $city, state: $state, postalCode: $postalCode, country: $country, isDefault: $isDefault, recipientName: $recipientName, recipientPhone: $recipientPhone, notes: $notes)';
  }
