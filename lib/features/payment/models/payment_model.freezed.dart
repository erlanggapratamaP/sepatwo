...
class _$PaymentModelImpl implements _PaymentModel {
  ...
  @override
  String toString() {
    return 'PaymentModel(id: $id, amount: $amount, currency: $currency, status: $status, paymentMethod: $paymentMethod, createdAt: $createdAt, description: $description, metadata: $metadata)';
  }
